System.register(['@angular/core', '@angular/platform-browser', '@angular/http', '@angular/forms', 'angular2-highcharts', './app.component', './navbar/navbar.component', './watchlist/watchlists.component', './watchlist/watchlist.component', './dashboard/dashboard.component', './common/watchlist.service', './common/quote.service', './common/sign.directive', './common/filterArr.pipe', './dashboard/fpchart.component', './dashboard/topstocks.component', 'ng2-typeahead'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, platform_browser_1, http_1, forms_1, angular2_highcharts_1, app_component_1, navbar_component_1, watchlists_component_1, watchlist_component_1, dashboard_component_1, watchlist_service_1, quote_service_1, sign_directive_1, filterArr_pipe_1, fpchart_component_1, topstocks_component_1, ng2_typeahead_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
            ...
            AppModule = (function () {
                ...
                AppModule = __decorate([
                    core_1.NgModule({
                        ...
                        declarations: [app_component_1.AppComponent, navbar_component_1.NavbarComponent, angular2_highcharts_1.CHART_DIRECTIVES, sign_directive_1.SignDirective, filterArr_pipe_1.FilterArrPipe, ng2_typeahead_1.Typeahead,
